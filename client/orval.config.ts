...
const common = {
  client: "axios",
  schemas: "./src/shared/api/gen/models.ts",
  override: {
    mutator: {
...
export default {
  ...
  recipes: {
    input: { target: SCHEMA_PATH, filters: { tags: ["Recipe"] } },
    output: { ...common, target: "./src/shared/api/gen/recipes.gen.ts" },
  },
  ingredients: {
    input: { target: SCHEMA_PATH, filters: { tags: ["Ingredient"] } },
    output: { ...common, target: "./src/shared/api/gen/ingredients.gen.ts" },
  },
  mealLogs: {
    input: { target: SCHEMA_PATH, filters: { tags: ["MealLog"] } },
